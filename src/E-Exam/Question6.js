...
const Question6 = ({ handleAnsweredBtn}) => {
    ...
    useEffect(()=>{
            if(allAnswers[5] !== 0 && allAnswers[5].startsWith('rad')){
                document.getElementById(allAnswers[5]).checked=true
            }
    },[])
    // for storing the users answer
    const handleRadio =(e)=>{
        allAnswers[5]=e.target.id
        handleAnsweredBtn('q6')
        ...
        <div className="quest">
            ...
            <div className="radios" >
                ...
                <div className="option3">
                    <input type="radio" onChange={(e)=>handleRadio(e)}  name="rad" value={0} id="rad3" style={{cursor:'pointer'}} /><label style={{cursor:'pointer'}} htmlFor="rad3"><h5>if (i != 5)</h5></label>
                </div>
